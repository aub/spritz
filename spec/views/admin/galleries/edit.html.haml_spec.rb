...
describe "/admin/galleries/edit.html.haml" do
  ...
  it "should render edit form" do
    render "/admin/galleries/edit.html.haml"
    
    response.should have_tag("form[action=#{admin_gallery_path(@gallery)}][method=post]") do
