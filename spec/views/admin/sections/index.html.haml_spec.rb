...
describe "/admin/sections/index.html.haml" do
  ...
  before(:each) do
    @section_type1 = mock_model(Hash, :title => 'ack', :section_name => 'section_type1', :admin_controller => 'admin/users')
    @section_type2 = mock_model(Hash, :title => 'ack', :section_name => 'section_type2', :admin_controller => 'admin/sites')
    assigns[:available_section_types] = [@section_type1, @section_type2]
    
    @section1 = mock_model(Section, :title => 'ack', :section_name => 'section1', :admin_controller => 'admin/users')
    @section2 = mock_model(Section, :title => 'ack', :section_name => 'section2', :admin_controller => 'admin/sites')
